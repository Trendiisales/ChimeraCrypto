...
// MimicLadderCompanion::seed_det_ring_hist (Config::catchup_max_age_bars).
...
static MimicLadderCompanion::Config base_cfg(int W = 4, double thr = 0.015) {
...
static bool det_in_of(MimicLadderCompanion& e) {
...
int main() {
    ...
    { // POSITIVE: recent jump, confirm never crossed -> window re-opened
        MimicLadderCompanion e(base_cfg());
