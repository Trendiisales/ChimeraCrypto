// S40 ADDS — 209 new engines from Gen-X --discover (46-sym × 10 TF × 144 grid × pyramid_xlow)
// All survive PF>=1.5 + net_bp>0 in ALL 4 WF windows (134/180/365/730d).
// Tag collisions vs main+s38+s39 dropped. RNDR/MKR/ICP/TON debut.
// ─── CONFIG + ENGINE + WIRE ─────────────────────────────────────────────
// 312666|rndrusdt,H1,TSMOM,60,18,3.0|min PF=1.59|134d 1.59 n=604|180d 2.19|365d 2.05|730d 2.13
chimera::EdgeEngine::Config s40_rndrusdt_tsmom_h1_cfg{
    .symbol="rndrusdt", .tag="RNDR-TSMOM-H1", .kind=chimera::StrategyKind::TSMOM,
...
chimera::EdgeEngine s40_rndrusdt_tsmom_h1(s40_rndrusdt_tsmom_h1_cfg);
wire_engine(s40_rndrusdt_tsmom_h1);

// 301470|rndrusdt,H3,TSMOM,60,3,1.0|min PF=1.97|134d 1.97 n=299|180d 2.24|365d 2.47|730d 2.23
chimera::EdgeEngine::Config s40_rndrusdt_tsmom_h3_cfg{
    .symbol="rndrusdt", .tag="RNDR-TSMOM-H3", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=10800, .lookback=60, .hold_bars=3, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_tsmom_h3(s40_rndrusdt_tsmom_h3_cfg);
wire_engine(s40_rndrusdt_tsmom_h3);

// 272695|rndrusdt,H4,TSMOM,60,18,2.0|min PF=2.42|134d 2.42 n=167|180d 2.85|365d 2.93|730d 2.94
chimera::EdgeEngine::Config s40_rndrusdt_tsmom_h4_cfg{
    .symbol="rndrusdt", .tag="RNDR-TSMOM-H4", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=14400, .lookback=60, .hold_bars=18, .sl_atr_mult=2.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_tsmom_h4(s40_rndrusdt_tsmom_h4_cfg);
wire_engine(s40_rndrusdt_tsmom_h4);

// 271541|rndrusdt,H2,TSMOM,60,8,1.0|min PF=1.61|134d 1.61 n=472|180d 1.70|365d 1.80|730d 1.94
chimera::EdgeEngine::Config s40_rndrusdt_tsmom_h2_cfg{
    .symbol="rndrusdt", .tag="RNDR-TSMOM-H2", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=7200, .lookback=60, .hold_bars=8, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_tsmom_h2(s40_rndrusdt_tsmom_h2_cfg);
wire_engine(s40_rndrusdt_tsmom_h2);

// 263306|rndrusdt,H6,TSMOM,60,24,1.0|min PF=2.38|134d 2.38 n=136|180d 2.64|365d 2.59|730d 2.83
chimera::EdgeEngine::Config s40_rndrusdt_tsmom_h6_cfg{
    .symbol="rndrusdt", .tag="RNDR-TSMOM-H6", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=21600, .lookback=60, .hold_bars=24, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_tsmom_h6(s40_rndrusdt_tsmom_h6_cfg);
wire_engine(s40_rndrusdt_tsmom_h6);

// 226715|mkrusdt,H4,TSMOM,60,5,2.0|min PF=3.12|134d 3.41 n=271|180d 3.33|365d 3.32|730d 3.12
chimera::EdgeEngine::Config s40_mkrusdt_tsmom_h4_cfg{
    .symbol="mkrusdt", .tag="MKR-TSMOM-H4", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=14400, .lookback=60, .hold_bars=5, .sl_atr_mult=2.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_tsmom_h4(s40_mkrusdt_tsmom_h4_cfg);
wire_engine(s40_mkrusdt_tsmom_h4);

// 223247|rndrusdt,H8,TSMOM,60,18,1.0|min PF=2.49|134d 2.94 n=99|180d 3.14|365d 2.92|730d 2.49
chimera::EdgeEngine::Config s40_rndrusdt_tsmom_h8_cfg{
    .symbol="rndrusdt", .tag="RNDR-TSMOM-H8", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=28800, .lookback=60, .hold_bars=18, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_tsmom_h8(s40_rndrusdt_tsmom_h8_cfg);
wire_engine(s40_rndrusdt_tsmom_h8);

// 215019|rndrusdt,H12,TSMOM,45,12,2.0|min PF=3.83|134d 4.71 n=44|180d 12.22|365d 6.45|730d 3.83
chimera::EdgeEngine::Config s40_rndrusdt_tsmom_h12_cfg{
    .symbol="rndrusdt", .tag="RNDR-TSMOM-H12", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=43200, .lookback=45, .hold_bars=12, .sl_atr_mult=2.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_tsmom_h12(s40_rndrusdt_tsmom_h12_cfg);
wire_engine(s40_rndrusdt_tsmom_h12);
...
// 207721|mkrusdt,H3,TSMOM,60,5,1.0|min PF=2.17|134d 2.17 n=384|180d 2.27|365d 2.32|730d 2.31
chimera::EdgeEngine::Config s40_mkrusdt_tsmom_h3_cfg{
    .symbol="mkrusdt", .tag="MKR-TSMOM-H3", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=10800, .lookback=60, .hold_bars=5, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_tsmom_h3(s40_mkrusdt_tsmom_h3_cfg);
wire_engine(s40_mkrusdt_tsmom_h3);
...
// 193725|mkrusdt,H2,TSMOM,60,24,1.0|min PF=1.70|134d 1.70 n=543|180d 1.78|365d 1.89|730d 1.89
chimera::EdgeEngine::Config s40_mkrusdt_tsmom_h2_cfg{
    .symbol="mkrusdt", .tag="MKR-TSMOM-H2", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=7200, .lookback=60, .hold_bars=24, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_tsmom_h2(s40_mkrusdt_tsmom_h2_cfg);
wire_engine(s40_mkrusdt_tsmom_h2);

// 191930|mkrusdt,H6,TSMOM,45,8,1.0|min PF=2.31|134d 2.31 n=215|180d 2.66|365d 2.98|730d 2.65
chimera::EdgeEngine::Config s40_mkrusdt_tsmom_h6_cfg{
    .symbol="mkrusdt", .tag="MKR-TSMOM-H6", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=21600, .lookback=45, .hold_bars=8, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_tsmom_h6(s40_mkrusdt_tsmom_h6_cfg);
wire_engine(s40_mkrusdt_tsmom_h6);

// 189877|rndrusdt,H1,ICHIMOKU,6,18,4.0|min PF=1.63|134d 1.63 n=321|180d 2.72|365d 2.11|730d 2.13
chimera::EdgeEngine::Config s40_rndrusdt_ichi_h1_cfg{
    .symbol="rndrusdt", .tag="RNDR-ICHI-H1", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=3600, .lookback=6, .hold_bars=18, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_ichi_h1(s40_rndrusdt_ichi_h1_cfg);
wire_engine(s40_rndrusdt_ichi_h1);

// 182851|rndrusdt,D1,TSMOM,60,3,2.0|min PF=3.31|134d 3.39 n=54|180d 4.21|365d 4.23|730d 3.31
chimera::EdgeEngine::Config s40_rndrusdt_tsmom_d1_cfg{
    .symbol="rndrusdt", .tag="RNDR-TSMOM-D1", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=86400, .lookback=60, .hold_bars=3, .sl_atr_mult=2.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_tsmom_d1(s40_rndrusdt_tsmom_d1_cfg);
wire_engine(s40_rndrusdt_tsmom_d1);
...
// 172514|mkrusdt,H8,TSMOM,60,5,1.0|min PF=2.74|134d 2.74 n=177|180d 2.96|365d 3.33|730d 2.75
chimera::EdgeEngine::Config s40_mkrusdt_tsmom_h8_cfg{
    .symbol="mkrusdt", .tag="MKR-TSMOM-H8", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=28800, .lookback=60, .hold_bars=5, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_tsmom_h8(s40_mkrusdt_tsmom_h8_cfg);
wire_engine(s40_mkrusdt_tsmom_h8);
...
// 169621|rndrusdt,D2,TSMOM,60,3,4.0|min PF=5.01|134d 5.01 n=37|180d 8.06|365d 6.81|730d 5.02
chimera::EdgeEngine::Config s40_rndrusdt_tsmom_d2_cfg{
    .symbol="rndrusdt", .tag="RNDR-TSMOM-D2", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=172800, .lookback=60, .hold_bars=3, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_tsmom_d2(s40_rndrusdt_tsmom_d2_cfg);
wire_engine(s40_rndrusdt_tsmom_d2);
...
// 158870|mkrusdt,H12,TSMOM,30,18,1.0|min PF=3.23|134d 4.67 n=106|180d 4.32|365d 3.52|730d 3.23
chimera::EdgeEngine::Config s40_mkrusdt_tsmom_h12_cfg{
    .symbol="mkrusdt", .tag="MKR-TSMOM-H12", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=43200, .lookback=30, .hold_bars=18, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_tsmom_h12(s40_mkrusdt_tsmom_h12_cfg);
wire_engine(s40_mkrusdt_tsmom_h12);

// 150868|rndrusdt,H6,ICHIMOKU,45,24,4.0|min PF=3.98|134d 4.39 n=54|180d 3.98|365d 4.17|730d 4.34
chimera::EdgeEngine::Config s40_rndrusdt_ichi_h6_cfg{
    .symbol="rndrusdt", .tag="RNDR-ICHI-H6", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=21600, .lookback=45, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_ichi_h6(s40_rndrusdt_ichi_h6_cfg);
wire_engine(s40_rndrusdt_ichi_h6);
...
// 143132|rndrusdt,D3,TSMOM,60,5,4.0|min PF=6.30|134d 6.30 n=29|180d 9.12|365d 7.26|730d 6.78
chimera::EdgeEngine::Config s40_rndrusdt_tsmom_d3_cfg{
    .symbol="rndrusdt", .tag="RNDR-TSMOM-D3", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=259200, .lookback=60, .hold_bars=5, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_tsmom_d3(s40_rndrusdt_tsmom_d3_cfg);
wire_engine(s40_rndrusdt_tsmom_d3);
...
// 141724|mkrusdt,H1,TSMOM,60,18,2.0|min PF=1.51|134d 1.51 n=763|180d 1.53|365d 1.51|730d 1.52
chimera::EdgeEngine::Config s40_mkrusdt_tsmom_h1_cfg{
    .symbol="mkrusdt", .tag="MKR-TSMOM-H1", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=3600, .lookback=60, .hold_bars=18, .sl_atr_mult=2.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_tsmom_h1(s40_mkrusdt_tsmom_h1_cfg);
wire_engine(s40_mkrusdt_tsmom_h1);
...
// 137437|rndrusdt,H8,ICHIMOKU,45,24,4.0|min PF=4.01|134d 5.65 n=34|180d 9.81|365d 5.10|730d 4.01
chimera::EdgeEngine::Config s40_rndrusdt_ichi_h8_cfg{
    .symbol="rndrusdt", .tag="RNDR-ICHI-H8", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=28800, .lookback=45, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_ichi_h8(s40_rndrusdt_ichi_h8_cfg);
wire_engine(s40_rndrusdt_ichi_h8);
...
// 133590|rndrusdt,H4,ICHIMOKU,30,24,4.0|min PF=1.78|134d 1.78 n=65|180d 2.19|365d 2.98|730d 3.25
chimera::EdgeEngine::Config s40_rndrusdt_ichi_h4_cfg{
    .symbol="rndrusdt", .tag="RNDR-ICHI-H4", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=14400, .lookback=30, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_ichi_h4(s40_rndrusdt_ichi_h4_cfg);
wire_engine(s40_rndrusdt_ichi_h4);

// 132760|rndrusdt,H12,ICHIMOKU,30,18,3.0|min PF=1.75|134d 1.75 n=22|180d 7.35|365d 5.61|730d 3.71
chimera::EdgeEngine::Config s40_rndrusdt_ichi_h12_cfg{
    .symbol="rndrusdt", .tag="RNDR-ICHI-H12", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=43200, .lookback=30, .hold_bars=18, .sl_atr_mult=3.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_ichi_h12(s40_rndrusdt_ichi_h12_cfg);
wire_engine(s40_rndrusdt_ichi_h12);
...
// 128438|rndrusdt,H3,ICHIMOKU,12,24,1.0|min PF=1.57|134d 1.57 n=161|180d 1.82|365d 1.79|730d 1.66
chimera::EdgeEngine::Config s40_rndrusdt_ichi_h3_cfg{
    .symbol="rndrusdt", .tag="RNDR-ICHI-H3", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=10800, .lookback=12, .hold_bars=24, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_ichi_h3(s40_rndrusdt_ichi_h3_cfg);
wire_engine(s40_rndrusdt_ichi_h3);
...
// 113523|mkrusdt,D1,TSMOM,60,3,1.0|min PF=2.61|134d 3.27 n=75|180d 2.90|365d 2.61|730d 3.18
chimera::EdgeEngine::Config s40_mkrusdt_tsmom_d1_cfg{
    .symbol="mkrusdt", .tag="MKR-TSMOM-D1", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=86400, .lookback=60, .hold_bars=3, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_tsmom_d1(s40_mkrusdt_tsmom_d1_cfg);
wire_engine(s40_mkrusdt_tsmom_d1);
...
// 111278|rndrusdt,H2,ICHIMOKU,6,5,3.0|min PF=1.52|134d 1.59 n=179|180d 2.05|365d 1.52|730d 1.78
chimera::EdgeEngine::Config s40_rndrusdt_ichi_h2_cfg{
    .symbol="rndrusdt", .tag="RNDR-ICHI-H2", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=7200, .lookback=6, .hold_bars=5, .sl_atr_mult=3.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_ichi_h2(s40_rndrusdt_ichi_h2_cfg);
wire_engine(s40_rndrusdt_ichi_h2);
...
// 106601|mkrusdt,H3,ICHIMOKU,60,24,4.0|min PF=2.06|134d 2.06 n=126|180d 2.64|365d 3.38|730d 2.98
chimera::EdgeEngine::Config s40_mkrusdt_ichi_h3_cfg{
    .symbol="mkrusdt", .tag="MKR-ICHI-H3", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=10800, .lookback=60, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_ichi_h3(s40_mkrusdt_ichi_h3_cfg);
wire_engine(s40_mkrusdt_ichi_h3);
...
// 104127|mkrusdt,H4,ICHIMOKU,12,5,2.0|min PF=1.70|134d 1.70 n=132|180d 2.04|365d 2.79|730d 2.59
chimera::EdgeEngine::Config s40_mkrusdt_ichi_h4_cfg{
    .symbol="mkrusdt", .tag="MKR-ICHI-H4", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=14400, .lookback=12, .hold_bars=5, .sl_atr_mult=2.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_ichi_h4(s40_mkrusdt_ichi_h4_cfg);
wire_engine(s40_mkrusdt_ichi_h4);
...
// 101496|mkrusdt,D2,TSMOM,60,8,1.0|min PF=3.83|134d 6.63 n=42|180d 9.28|365d 5.92|730d 3.83
chimera::EdgeEngine::Config s40_mkrusdt_tsmom_d2_cfg{
    .symbol="mkrusdt", .tag="MKR-TSMOM-D2", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=172800, .lookback=60, .hold_bars=8, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_tsmom_d2(s40_mkrusdt_tsmom_d2_cfg);
wire_engine(s40_mkrusdt_tsmom_d2);
...
// 97178|mkrusdt,H2,ICHIMOKU,60,24,2.0|min PF=1.69|134d 1.69 n=223|180d 1.84|365d 1.88|730d 1.86
chimera::EdgeEngine::Config s40_mkrusdt_ichi_h2_cfg{
    .symbol="mkrusdt", .tag="MKR-ICHI-H2", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=7200, .lookback=60, .hold_bars=24, .sl_atr_mult=2.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_ichi_h2(s40_mkrusdt_ichi_h2_cfg);
wire_engine(s40_mkrusdt_ichi_h2);
...
// 81774|rndrusdt,D1,ICHIMOKU,18,12,4.0|min PF=1.77|134d 1.77 n=21|180d 3.32|365d 6.50|730d 4.44
chimera::EdgeEngine::Config s40_rndrusdt_ichi_d1_cfg{
    .symbol="rndrusdt", .tag="RNDR-ICHI-D1", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=86400, .lookback=18, .hold_bars=12, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_ichi_d1(s40_rndrusdt_ichi_d1_cfg);
wire_engine(s40_rndrusdt_ichi_d1);
...
// 78733|rndrusdt,H8,STOCH_RSI,60,18,4.0|min PF=3.33|134d 5.69 n=32|180d 5.27|365d 3.33|730d 3.80
chimera::EdgeEngine::Config s40_rndrusdt_sr_h8_cfg{
    .symbol="rndrusdt", .tag="RNDR-SR-H8", .kind=chimera::StrategyKind::STOCH_RSI,
    .tf_secs=28800, .lookback=60, .hold_bars=18, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_sr_h8(s40_rndrusdt_sr_h8_cfg);
wire_engine(s40_rndrusdt_sr_h8);
...
// 77890|mkrusdt,H8,ICHIMOKU,18,5,1.0|min PF=2.13|134d 2.13 n=79|180d 2.27|365d 3.22|730d 2.16
chimera::EdgeEngine::Config s40_mkrusdt_ichi_h8_cfg{
    .symbol="mkrusdt", .tag="MKR-ICHI-H8", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=28800, .lookback=18, .hold_bars=5, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_ichi_h8(s40_mkrusdt_ichi_h8_cfg);
wire_engine(s40_mkrusdt_ichi_h8);
...
// 76215|mkrusdt,D3,TSMOM,45,5,3.0|min PF=3.56|134d 6.95 n=23|180d 7.73|365d 3.56|730d 5.39
chimera::EdgeEngine::Config s40_mkrusdt_tsmom_d3_cfg{
    .symbol="mkrusdt", .tag="MKR-TSMOM-D3", .kind=chimera::StrategyKind::TSMOM,
    .tf_secs=259200, .lookback=45, .hold_bars=5, .sl_atr_mult=3.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_tsmom_d3(s40_mkrusdt_tsmom_d3_cfg);
wire_engine(s40_mkrusdt_tsmom_d3);
...
// 74294|mkrusdt,H12,ICHIMOKU,45,8,1.0|min PF=2.69|134d 2.97 n=53|180d 2.69|365d 2.83|730d 2.70
chimera::EdgeEngine::Config s40_mkrusdt_ichi_h12_cfg{
    .symbol="mkrusdt", .tag="MKR-ICHI-H12", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=43200, .lookback=45, .hold_bars=8, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_ichi_h12(s40_mkrusdt_ichi_h12_cfg);
wire_engine(s40_mkrusdt_ichi_h12);
...
// 61618|rndrusdt,H4,STOCH_RSI,60,24,4.0|min PF=1.88|134d 2.00 n=65|180d 1.88|365d 2.06|730d 2.35
chimera::EdgeEngine::Config s40_rndrusdt_sr_h4_cfg{
    .symbol="rndrusdt", .tag="RNDR-SR-H4", .kind=chimera::StrategyKind::STOCH_RSI,
    .tf_secs=14400, .lookback=60, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_sr_h4(s40_rndrusdt_sr_h4_cfg);
wire_engine(s40_rndrusdt_sr_h4);
...
// 58450|rndrusdt,H12,STOCH_RSI,60,24,4.0|min PF=2.34|134d 2.73 n=21|180d 4.52|365d 5.02|730d 2.34
chimera::EdgeEngine::Config s40_rndrusdt_sr_h12_cfg{
    .symbol="rndrusdt", .tag="RNDR-SR-H12", .kind=chimera::StrategyKind::STOCH_RSI,
    .tf_secs=43200, .lookback=60, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_sr_h12(s40_rndrusdt_sr_h12_cfg);
wire_engine(s40_rndrusdt_sr_h12);
...
// 49282|rndrusdt,D2,ICHIMOKU,12,3,1.0|min PF=1.55|134d 1.55 n=21|180d 1.77|365d 1.91|730d 2.00
chimera::EdgeEngine::Config s40_rndrusdt_ichi_d2_cfg{
    .symbol="rndrusdt", .tag="RNDR-ICHI-D2", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=172800, .lookback=12, .hold_bars=3, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_ichi_d2(s40_rndrusdt_ichi_d2_cfg);
wire_engine(s40_rndrusdt_ichi_d2);

// 49006|rndrusdt,H4,WILLIAMS_R,60,24,4.0|min PF=1.99|134d 2.45 n=57|180d 2.09|365d 1.99|730d 2.00
chimera::EdgeEngine::Config s40_rndrusdt_willr_h4_cfg{
    .symbol="rndrusdt", .tag="RNDR-WILLR-H4", .kind=chimera::StrategyKind::WILLIAMS_R,
    .tf_secs=14400, .lookback=60, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_willr_h4(s40_rndrusdt_willr_h4_cfg);
wire_engine(s40_rndrusdt_willr_h4);

// 48808|mkrusdt,H6,ICHIMOKU,12,12,4.0|min PF=1.56|134d 1.56 n=79|180d 1.56|365d 1.91|730d 1.93
chimera::EdgeEngine::Config s40_mkrusdt_ichi_h6_cfg{
    .symbol="mkrusdt", .tag="MKR-ICHI-H6", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=21600, .lookback=12, .hold_bars=12, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_ichi_h6(s40_mkrusdt_ichi_h6_cfg);
wire_engine(s40_mkrusdt_ichi_h6);

// 48428|mkrusdt,D2,ICHIMOKU,18,8,1.0|min PF=2.81|134d 6.32 n=25|180d 37.64|365d 3.96|730d 2.81
chimera::EdgeEngine::Config s40_mkrusdt_ichi_d2_cfg{
    .symbol="mkrusdt", .tag="MKR-ICHI-D2", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=172800, .lookback=18, .hold_bars=8, .sl_atr_mult=1.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_ichi_d2(s40_mkrusdt_ichi_d2_cfg);
wire_engine(s40_mkrusdt_ichi_d2);

// 47804|mkrusdt,D1,ICHIMOKU,60,8,4.0|min PF=1.72|134d 6.59 n=35|180d 3.04|365d 1.72|730d 2.54
chimera::EdgeEngine::Config s40_mkrusdt_ichi_d1_cfg{
    .symbol="mkrusdt", .tag="MKR-ICHI-D1", .kind=chimera::StrategyKind::ICHIMOKU,
    .tf_secs=86400, .lookback=60, .hold_bars=8, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_ichi_d1(s40_mkrusdt_ichi_d1_cfg);
wire_engine(s40_mkrusdt_ichi_d1);
...
// 44364|rndrusdt,H12,WILLIAMS_R,6,24,3.0|min PF=2.05|134d 4.01 n=23|180d 5.63|365d 5.11|730d 2.05
chimera::EdgeEngine::Config s40_rndrusdt_willr_h12_cfg{
    .symbol="rndrusdt", .tag="RNDR-WILLR-H12", .kind=chimera::StrategyKind::WILLIAMS_R,
    .tf_secs=43200, .lookback=6, .hold_bars=24, .sl_atr_mult=3.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_willr_h12(s40_rndrusdt_willr_h12_cfg);
wire_engine(s40_rndrusdt_willr_h12);
...
// 43205|rndrusdt,H3,WILLIAMS_R,6,18,4.0|min PF=1.55|134d 1.72 n=74|180d 2.38|365d 2.07|730d 1.55
chimera::EdgeEngine::Config s40_rndrusdt_willr_h3_cfg{
    .symbol="rndrusdt", .tag="RNDR-WILLR-H3", .kind=chimera::StrategyKind::WILLIAMS_R,
    .tf_secs=10800, .lookback=6, .hold_bars=18, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_willr_h3(s40_rndrusdt_willr_h3_cfg);
wire_engine(s40_rndrusdt_willr_h3);
...
// 41783|rndrusdt,H4,BREAKOUT_PULLBACK,18,24,4.0|min PF=2.61|134d 42.48 n=22|180d 7.64|365d 3.82|730d 2.61
chimera::EdgeEngine::Config s40_rndrusdt_bopb_h4_cfg{
    .symbol="rndrusdt", .tag="RNDR-BOPB-H4", .kind=chimera::StrategyKind::BREAKOUT_PULLBACK,
    .tf_secs=14400, .lookback=18, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_bopb_h4(s40_rndrusdt_bopb_h4_cfg);
wire_engine(s40_rndrusdt_bopb_h4);
...
// 37809|mkrusdt,H8,STOCH_RSI,45,12,4.0|min PF=1.88|134d 5.32 n=32|180d 7.37|365d 3.52|730d 1.88
chimera::EdgeEngine::Config s40_mkrusdt_sr_h8_cfg{
    .symbol="mkrusdt", .tag="MKR-SR-H8", .kind=chimera::StrategyKind::STOCH_RSI,
    .tf_secs=28800, .lookback=45, .hold_bars=12, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_sr_h8(s40_mkrusdt_sr_h8_cfg);
wire_engine(s40_mkrusdt_sr_h8);

// 37648|mkrusdt,H12,STOCH_RSI,30,18,4.0|min PF=1.94|134d 4.28 n=23|180d 152.69|365d 2.27|730d 1.94
chimera::EdgeEngine::Config s40_mkrusdt_sr_h12_cfg{
    .symbol="mkrusdt", .tag="MKR-SR-H12", .kind=chimera::StrategyKind::STOCH_RSI,
    .tf_secs=43200, .lookback=30, .hold_bars=18, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_sr_h12(s40_mkrusdt_sr_h12_cfg);
wire_engine(s40_mkrusdt_sr_h12);
...
// 34585|rndrusdt,H3,BREAKOUT_PULLBACK,12,24,4.0|min PF=1.75|134d 31.61 n=31|180d 53.98|365d 1.94|730d 1.75
chimera::EdgeEngine::Config s40_rndrusdt_bopb_h3_cfg{
    .symbol="rndrusdt", .tag="RNDR-BOPB-H3", .kind=chimera::StrategyKind::BREAKOUT_PULLBACK,
    .tf_secs=10800, .lookback=12, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_bopb_h3(s40_rndrusdt_bopb_h3_cfg);
wire_engine(s40_rndrusdt_bopb_h3);
...
// 28147|rndrusdt,H6,BREAKOUT_PULLBACK,6,24,4.0|min PF=1.55|134d 1.55 n=22|180d 2.61|365d 1.86|730d 1.89
chimera::EdgeEngine::Config s40_rndrusdt_bopb_h6_cfg{
    .symbol="rndrusdt", .tag="RNDR-BOPB-H6", .kind=chimera::StrategyKind::BREAKOUT_PULLBACK,
    .tf_secs=21600, .lookback=6, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_bopb_h6(s40_rndrusdt_bopb_h6_cfg);
wire_engine(s40_rndrusdt_bopb_h6);
...
// 27662|mkrusdt,H4,WILLIAMS_R,60,24,4.0|min PF=1.60|134d 2.40 n=47|180d 3.06|365d 1.68|730d 1.60
chimera::EdgeEngine::Config s40_mkrusdt_willr_h4_cfg{
    .symbol="mkrusdt", .tag="MKR-WILLR-H4", .kind=chimera::StrategyKind::WILLIAMS_R,
    .tf_secs=14400, .lookback=60, .hold_bars=24, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_willr_h4(s40_mkrusdt_willr_h4_cfg);
wire_engine(s40_mkrusdt_willr_h4);

// 25887|mkrusdt,H8,WILLIAMS_R,60,18,4.0|min PF=1.65|134d 160.26 n=32|180d 100.27|365d 2.08|730d 1.65
chimera::EdgeEngine::Config s40_mkrusdt_willr_h8_cfg{
    .symbol="mkrusdt", .tag="MKR-WILLR-H8", .kind=chimera::StrategyKind::WILLIAMS_R,
    .tf_secs=28800, .lookback=60, .hold_bars=18, .sl_atr_mult=4.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_mkrusdt_willr_h8(s40_mkrusdt_willr_h8_cfg);
wire_engine(s40_mkrusdt_willr_h8);
...
// 15595|rndrusdt,H3,BOLLINGER,6,24,3.0|min PF=1.59|134d 119.33 n=20|180d 163.76|365d 2.93|730d 1.59
chimera::EdgeEngine::Config s40_rndrusdt_boll_h3_cfg{
    .symbol="rndrusdt", .tag="RNDR-BOLL-H3", .kind=chimera::StrategyKind::BOLLINGER,
    .tf_secs=10800, .lookback=6, .hold_bars=24, .sl_atr_mult=3.0, .atr_period=14,
    .bb_k=2.0, .rsi_threshold=30.0, .round_trip_bp=22, .max_history=128,
    .trail_arm_atr=1.0, .trail_dist_atr=0.5, .trail_tighten_atr=3.0, .trail_tighten_dist_atr=0.25,
};
chimera::EdgeEngine s40_rndrusdt_boll_h3(s40_rndrusdt_boll_h3_cfg);
wire_engine(s40_rndrusdt_boll_h3);
...
// ─── PUSH_BACK BLOCKS ─────
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_tsmom_h1, "rndrusdt", 3600, "RNDR-TSMOM-H1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_tsmom_h3, "rndrusdt", 10800, "RNDR-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_tsmom_h4, "rndrusdt", 14400, "RNDR-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_tsmom_h2, "rndrusdt", 7200, "RNDR-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_tsmom_h6, "rndrusdt", 21600, "RNDR-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_tsmom_h4, "mkrusdt", 14400, "MKR-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_tsmom_h8, "rndrusdt", 28800, "RNDR-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_tsmom_h12, "rndrusdt", 43200, "RNDR-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_tsmom_h2, "icpusdt", 7200, "ICP-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_tsmom_h3, "mkrusdt", 10800, "MKR-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_tsmom_h1, "icpusdt", 3600, "ICP-TSMOM-H1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_tsmom_h3, "icpusdt", 10800, "ICP-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_tsmom_h2, "mkrusdt", 7200, "MKR-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_tsmom_h6, "mkrusdt", 21600, "MKR-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_ichi_h1, "rndrusdt", 3600, "RNDR-ICHI-H1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_tsmom_d1, "rndrusdt", 86400, "RNDR-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_tsmom_h1, "compusdt", 3600, "COMP-TSMOM-H1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_tsmom_h2, "crvusdt", 7200, "CRV-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_tsmom_h2, "imxusdt", 7200, "IMX-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_tsmom_h2, "compusdt", 7200, "COMP-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_tsmom_h2, "pythusdt", 7200, "PYTH-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_tsmom_h8, "mkrusdt", 28800, "MKR-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_tsmom_h3, "compusdt", 10800, "COMP-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_tsmom_d2, "rndrusdt", 172800, "RNDR-TSMOM-D2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_tsmom_h4, "icpusdt", 14400, "ICP-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_tsmom_h4, "imxusdt", 14400, "IMX-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_tsmom_h4, "compusdt", 14400, "COMP-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_tsmom_h12, "mkrusdt", 43200, "MKR-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_ichi_h6, "rndrusdt", 21600, "RNDR-ICHI-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_ichi_h2, "icpusdt", 7200, "ICP-ICHI-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_tsmom_h6, "compusdt", 21600, "COMP-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_tsmom_h6, "imxusdt", 21600, "IMX-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_tsmom_h2, "manausdt", 7200, "MANA-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_tsmom_h3, "pythusdt", 10800, "PYTH-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_tsmom_h8, "icpusdt", 28800, "ICP-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_tsmom_h3, "imxusdt", 10800, "IMX-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_tsmom_d3, "rndrusdt", 259200, "RNDR-TSMOM-D3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_tsmom_h3, "crvusdt", 10800, "CRV-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_tsmom_h6, "icpusdt", 21600, "ICP-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_tsmom_h1, "mkrusdt", 3600, "MKR-TSMOM-H1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_tsmom_h2, "arkmusdt", 7200, "ARKM-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_tsmom_h2, "sandusdt", 7200, "SAND-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_tsmom_h4, "pythusdt", 14400, "PYTH-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_tsmom_h2, "stxusdt", 7200, "STX-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_ichi_h8, "rndrusdt", 28800, "RNDR-ICHI-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_tsmom_h4, "arkmusdt", 14400, "ARKM-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_ichi_h4, "rndrusdt", 14400, "RNDR-ICHI-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_ichi_h12, "rndrusdt", 43200, "RNDR-ICHI-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_tsmom_h8, "imxusdt", 28800, "IMX-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_tsmom_h1, "stxusdt", 3600, "STX-TSMOM-H1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_tsmom_h8, "compusdt", 28800, "COMP-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_tsmom_h6, "pythusdt", 21600, "PYTH-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_ichi_h1, "icpusdt", 3600, "ICP-ICHI-H1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_ichi_h3, "rndrusdt", 10800, "RNDR-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MASK, &s40_maskusdt_tsmom_h2, "maskusdt", 7200, "MASK-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_tsmom_h3, "stxusdt", 10800, "STX-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_tsmom_h6, "stxusdt", 21600, "STX-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_tsmom_h4, "crvusdt", 14400, "CRV-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_tsmom_h3, "sandusdt", 10800, "SAND-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MASK, &s40_maskusdt_tsmom_h3, "maskusdt", 10800, "MASK-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MASK, &s40_maskusdt_tsmom_h4, "maskusdt", 14400, "MASK-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_tsmom_h6, "arkmusdt", 21600, "ARKM-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_tsmom_h12, "arkmusdt", 43200, "ARKM-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_tsmom_h8, "stxusdt", 28800, "STX-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_DOT, &s40_dotusdt_tsmom_h3, "dotusdt", 10800, "DOT-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MASK, &s40_maskusdt_tsmom_h1, "maskusdt", 3600, "MASK-TSMOM-H1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_tsmom_h4, "sandusdt", 14400, "SAND-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_GRT, &s40_grtusdt_tsmom_h2, "grtusdt", 7200, "GRT-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_tsmom_h12, "pythusdt", 43200, "PYTH-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_tsmom_d1, "mkrusdt", 86400, "MKR-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_tsmom_h6, "manausdt", 21600, "MANA-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_ichi_h2, "rndrusdt", 7200, "RNDR-ICHI-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_tsmom_h12, "compusdt", 43200, "COMP-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_tsmom_h12, "crvusdt", 43200, "CRV-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_tsmom_h12, "icpusdt", 43200, "ICP-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_tsmom_d1, "icpusdt", 86400, "ICP-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_tsmom_h8, "pythusdt", 28800, "PYTH-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_tsmom_h8, "crvusdt", 28800, "CRV-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_ichi_h3, "mkrusdt", 10800, "MKR-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_tsmom_h8, "arkmusdt", 28800, "ARKM-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MASK, &s40_maskusdt_tsmom_h6, "maskusdt", 21600, "MASK-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_tsmom_d2, "icpusdt", 172800, "ICP-TSMOM-D2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_ichi_h4, "mkrusdt", 14400, "MKR-ICHI-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_tsmom_h12, "imxusdt", 43200, "IMX-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_tsmom_h4, "stxusdt", 14400, "STX-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_tsmom_h4, "manausdt", 14400, "MANA-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_DOT, &s40_dotusdt_tsmom_h4, "dotusdt", 14400, "DOT-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_tsmom_d2, "mkrusdt", 172800, "MKR-TSMOM-D2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_tsmom_h12, "stxusdt", 43200, "STX-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MASK, &s40_maskusdt_tsmom_h12, "maskusdt", 43200, "MASK-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_ichi_h3, "icpusdt", 10800, "ICP-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_tsmom_h6, "sandusdt", 21600, "SAND-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_DOT, &s40_dotusdt_tsmom_h2, "dotusdt", 7200, "DOT-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_ichi_h2, "mkrusdt", 7200, "MKR-ICHI-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_DOT, &s40_dotusdt_tsmom_h6, "dotusdt", 21600, "DOT-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_tsmom_d1, "pythusdt", 86400, "PYTH-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_ichi_h2, "compusdt", 7200, "COMP-ICHI-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_tsmom_h8, "sandusdt", 28800, "SAND-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MASK, &s40_maskusdt_tsmom_h8, "maskusdt", 28800, "MASK-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_GRT, &s40_grtusdt_tsmom_h4, "grtusdt", 14400, "GRT-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_ichi_h2, "imxusdt", 7200, "IMX-ICHI-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_tsmom_d1, "imxusdt", 86400, "IMX-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_GRT, &s40_grtusdt_tsmom_h3, "grtusdt", 10800, "GRT-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_tsmom_d1, "arkmusdt", 86400, "ARKM-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_tsmom_h12, "manausdt", 43200, "MANA-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_ichi_h6, "compusdt", 21600, "COMP-ICHI-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_tsmom_h3, "manausdt", 10800, "MANA-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_tsmom_d1, "compusdt", 86400, "COMP-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_tsmom_d2, "pythusdt", 172800, "PYTH-TSMOM-D2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_tsmom_h6, "crvusdt", 21600, "CRV-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_ichi_d1, "rndrusdt", 86400, "RNDR-ICHI-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_ichi_h4, "compusdt", 14400, "COMP-ICHI-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_ichi_h4, "arkmusdt", 14400, "ARKM-ICHI-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_tsmom_h12, "sandusdt", 43200, "SAND-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_DOT, &s40_dotusdt_tsmom_h8, "dotusdt", 28800, "DOT-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_ichi_h4, "imxusdt", 14400, "IMX-ICHI-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_ichi_h2, "pythusdt", 7200, "PYTH-ICHI-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_sr_h8, "rndrusdt", 28800, "RNDR-SR-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_DOT, &s40_dotusdt_tsmom_h12, "dotusdt", 43200, "DOT-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_ichi_h4, "icpusdt", 14400, "ICP-ICHI-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_tsmom_h8, "manausdt", 28800, "MANA-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_ichi_h8, "mkrusdt", 28800, "MKR-ICHI-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_ichi_h2, "stxusdt", 7200, "STX-ICHI-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_ichi_h3, "crvusdt", 10800, "CRV-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MASK, &s40_maskusdt_tsmom_d1, "maskusdt", 86400, "MASK-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_ichi_h3, "stxusdt", 10800, "STX-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_tsmom_d3, "mkrusdt", 259200, "MKR-TSMOM-D3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_GRT, &s40_grtusdt_tsmom_h8, "grtusdt", 28800, "GRT-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MASK, &s40_maskusdt_ichi_h2, "maskusdt", 7200, "MASK-ICHI-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_ichi_h3, "imxusdt", 10800, "IMX-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_GRT, &s40_grtusdt_tsmom_h12, "grtusdt", 43200, "GRT-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_ichi_h12, "mkrusdt", 43200, "MKR-ICHI-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_ichi_h8, "crvusdt", 28800, "CRV-ICHI-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MASK, &s40_maskusdt_ichi_h3, "maskusdt", 10800, "MASK-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_ichi_h2, "sandusdt", 7200, "SAND-ICHI-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_ichi_h3, "sandusdt", 10800, "SAND-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_ichi_h3, "compusdt", 10800, "COMP-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_tsmom_d1, "manausdt", 86400, "MANA-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_tsmom_h2, "tonusdt", 7200, "TON-TSMOM-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_ichi_h4, "manausdt", 14400, "MANA-ICHI-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_ichi_h4, "crvusdt", 14400, "CRV-ICHI-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_tsmom_d1, "crvusdt", 86400, "CRV-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_ichi_h6, "manausdt", 21600, "MANA-ICHI-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_tsmom_d2, "arkmusdt", 172800, "ARKM-TSMOM-D2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_tsmom_d1, "stxusdt", 86400, "STX-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_sr_h4, "rndrusdt", 14400, "RNDR-SR-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_ichi_h6, "sandusdt", 21600, "SAND-ICHI-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_ichi_h6, "arkmusdt", 21600, "ARKM-ICHI-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_sr_h12, "rndrusdt", 43200, "RNDR-SR-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_tsmom_h3, "tonusdt", 10800, "TON-TSMOM-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_ichi_h12, "crvusdt", 43200, "CRV-ICHI-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_CRV, &s40_crvusdt_tsmom_d2, "crvusdt", 172800, "CRV-TSMOM-D2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_tsmom_h8, "tonusdt", 28800, "TON-TSMOM-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_tsmom_h12, "tonusdt", 43200, "TON-TSMOM-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_tsmom_d1, "sandusdt", 86400, "SAND-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_STX, &s40_stxusdt_ichi_h4, "stxusdt", 14400, "STX-ICHI-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_ichi_d2, "rndrusdt", 172800, "RNDR-ICHI-D2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_willr_h4, "rndrusdt", 14400, "RNDR-WILLR-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_ichi_h6, "mkrusdt", 21600, "MKR-ICHI-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_ichi_d2, "mkrusdt", 172800, "MKR-ICHI-D2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_ichi_d1, "mkrusdt", 86400, "MKR-ICHI-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_sr_h12, "compusdt", 43200, "COMP-SR-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_ichi_h12, "manausdt", 43200, "MANA-ICHI-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_tsmom_h6, "tonusdt", 21600, "TON-TSMOM-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_GRT, &s40_grtusdt_ichi_h3, "grtusdt", 10800, "GRT-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_willr_h12, "rndrusdt", 43200, "RNDR-WILLR-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_ichi_h3, "tonusdt", 10800, "TON-ICHI-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_willr_h3, "rndrusdt", 10800, "RNDR-WILLR-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_tsmom_h4, "tonusdt", 14400, "TON-TSMOM-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_ichi_h2, "tonusdt", 7200, "TON-ICHI-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_ichi_h6, "pythusdt", 21600, "PYTH-ICHI-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_bopb_h4, "rndrusdt", 14400, "RNDR-BOPB-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_willr_h6, "arkmusdt", 21600, "ARKM-WILLR-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_DOT, &s40_dotusdt_ichi_h4, "dotusdt", 14400, "DOT-ICHI-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_GRT, &s40_grtusdt_tsmom_d1, "grtusdt", 86400, "GRT-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ICP, &s40_icpusdt_ichi_h8, "icpusdt", 28800, "ICP-ICHI-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_ichi_h6, "tonusdt", 21600, "TON-ICHI-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_ichi_h8, "imxusdt", 28800, "IMX-ICHI-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_sr_h8, "mkrusdt", 28800, "MKR-SR-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_sr_h12, "mkrusdt", 43200, "MKR-SR-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_ichi_h6, "imxusdt", 21600, "IMX-ICHI-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_ichi_h8, "manausdt", 28800, "MANA-ICHI-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_bopb_h3, "rndrusdt", 10800, "RNDR-BOPB-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_ichi_h8, "pythusdt", 28800, "PYTH-ICHI-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_willr_h12, "arkmusdt", 43200, "ARKM-WILLR-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_tsmom_d1, "tonusdt", 86400, "TON-TSMOM-D1", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_tsmom_d2, "compusdt", 172800, "COMP-TSMOM-D2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_ichi_h8, "tonusdt", 28800, "TON-ICHI-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_ichi_h8, "sandusdt", 28800, "SAND-ICHI-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_ichi_h12, "tonusdt", 43200, "TON-ICHI-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_bopb_h6, "rndrusdt", 21600, "RNDR-BOPB-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_dt_h12, "sandusdt", 43200, "SAND-DT-H12", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_willr_h4, "mkrusdt", 14400, "MKR-WILLR-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MKR, &s40_mkrusdt_willr_h8, "mkrusdt", 28800, "MKR-WILLR-H8", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_bopb_h2, "pythusdt", 7200, "PYTH-BOPB-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_tsmom_d2, "tonusdt", 172800, "TON-TSMOM-D2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_IMX, &s40_imxusdt_bopb_h4, "imxusdt", 14400, "IMX-BOPB-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_bopb_h4, "manausdt", 14400, "MANA-BOPB-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_dch_h4, "pythusdt", 14400, "PYTH-DCH-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_ARKM, &s40_arkmusdt_boll_h3, "arkmusdt", 10800, "ARKM-BOLL-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_PYTH, &s40_pythusdt_bopb_h3, "pythusdt", 10800, "PYTH-BOPB-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_MANA, &s40_manausdt_bopb_h6, "manausdt", 21600, "MANA-BOPB-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_dch_h6, "sandusdt", 21600, "SAND-DCH-H6", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_RNDR, &s40_rndrusdt_boll_h3, "rndrusdt", 10800, "RNDR-BOLL-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_SAND, &s40_sandusdt_bopb_h3, "sandusdt", 10800, "SAND-BOPB-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_bopb_h4, "tonusdt", 14400, "TON-BOPB-H4", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_bopb_h3, "tonusdt", 10800, "TON-BOPB-H3", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_TON, &s40_tonusdt_bopb_h2, "tonusdt", 7200, "TON-BOPB-H2", 0.00, 0.0, 100, 730, 40});
g_slots.push_back({chimera::SYM_COMP, &s40_compusdt_kelt_h4, "compusdt", 14400, "COMP-KELT-H4", 0.00, 0.0, 100, 730, 40});
