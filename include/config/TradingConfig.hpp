...
struct TradingConfig {
    ...
    // -------------------------------------------------------------------------
    static constexpr double  LEADLAG_BTC_THRESHOLD_BP   = 5.0;  // REVERTED: 3bp produces ~5-8bp alt continuation, below 15bp cost floor; 5bp produces 15-25bp continuation with real edge
