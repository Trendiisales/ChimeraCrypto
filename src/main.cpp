...
// Build version header — generated by CMake gen_version target on every make.
// Defines BUILD_VERSION as the current git short hash.
// Falls back gracefully if header not yet generated (first cmake run).
