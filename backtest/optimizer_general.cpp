...
//
// Build:
//   cd backtest && g++ -std=c++17 -O2 -I../include optimizer_general.cpp -o optimizer_general
//
// Usage:
...
int main(int argc, char* argv[]) {
    ...
    std::printf("[LOAD] Loading %s klines for %s %s...\n", symbol.c_str(), strat_s.c_str(), tf_s.c_str());
