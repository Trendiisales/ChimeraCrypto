...
// Build version — generated by CMake gen_version target on every make.
// gen_version runs before compilation so this header always exists at build time.
// Falls back to "dev" if somehow missing (IDE builds outside cmake).
